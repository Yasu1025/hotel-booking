        ...
        <div id='booking_invoice' className='px-4 border border-secondary'>
          <header className='clearfix'>
            <div id='logo' className='my-4'>
              <img src='/images/hotel-booking_logo.png' alt='logo' />
            </div>
            ...
            <div id='project'>
              ...
              <div>
                <span>DATE</span> {new Date(booking.createdAt).toLocaleString('en-US')}
              </div>
              <div>
            ...
            <table className='mt-5'>
              ...
              <tbody>
                <tr>
                  ...
                  <td className='desc'>{booking.amountPaid}</td>
                  <td className='unit'>
                ...
                <tr>
                  ...
                  <td className='grand total'>$500.00</td>
                </tr>
              </tbody>
            </table>
            <div id='notices'>
